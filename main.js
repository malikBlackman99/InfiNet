...
var defaultUsers = [
    ...
    var defaultPosts = [
        { id:1,  user:"_xlia0.o",       category:"travel",      text:"golden hour over the valley 🌿 #travel #photography",                 likes:24, likedBy: [],bookmarkedBy: [], comments:["User143: Comment here!", "loveStay: Nah, comment there."], img: categoryImages.travel[0] },
        { id:6,  user:"travelwithkai",  category:"travel",      text:"found this hidden waterfall on a hike 🌊 worth every step",            likes:52, likedBy: [],bookmarkedBy: [], comments:["nomad.co: where is this?!", "kai_world: Dominica!"],         img: categoryImages.travel[1] },
        { id:11, user:"roamingrita",    category:"travel",      text:"cobblestone streets and no wifi. living my best life 🧭",              likes:47, likedBy: [],bookmarkedBy: [], comments:["wanderlust.k: dream trip"],                                   img: categoryImages.travel[2] },
        { id:16, user:"viewfromhere",   category:"travel",      text:"bus windows are the best photo studios 🚌🌄 #roadtrip",                likes:31, likedBy: [],bookmarkedBy: [], comments:[],                                                            img: categoryImages.travel[3] },
        { id:2,  user:"mk_frames",      category:"food",        text:"morning ritual, slow and warm ☕ #food #slowliving",                   likes:11, likedBy: [],bookmarkedBy: [], comments:[],                                                            img: categoryImages.food[0] },
        { id:7,  user:"platefully",     category:"food",        text:"homemade ramen from scratch 🍜 took 3 hours, gone in 10 mins",         likes:44, likedBy: [],bookmarkedBy: [], comments:["foodie99: recipe please!"],                                  img: categoryImages.food[1] },
        { id:12, user:"cafe.culture",   category:"food",        text:"this croissant changed my life 🥐 paris did not disappoint",           likes:38, likedBy: [],bookmarkedBy: [], comments:["breaddaily: goals"],                                         img: categoryImages.food[2] },
        { id:17, user:"fermentfiona",   category:"food",        text:"first sourdough loaf of the season 🍞 the crust crackle 🤌",           likes:26, likedBy: [],bookmarkedBy: [], comments:["breadhead: perfection"],                                     img: categoryImages.food[3] },
        { id:3,  user:"jnvisions",      category:"nature",      text:"stillness between the trees 🌲 #nature",                              likes:37, likedBy: [],bookmarkedBy: [], comments:["greenleaf: so peaceful!"],                                   img: categoryImages.nature[0] },
        { id:8,  user:"earthframes",    category:"nature",      text:"dawn at the coast 🌅 woke up at 4am for this shot",                   likes:61, likedBy: [],bookmarkedBy: [], comments:[],                                                            img: categoryImages.nature[1] },
        { id:13, user:"soilsong",       category:"nature",      text:"replanted my whole balcony garden 🌱 watching things grow is therapy", likes:22, likedBy: [],bookmarkedBy: [], comments:[],                                                            img: categoryImages.nature[2] },
        { id:18, user:"mossgarden",     category:"nature",      text:"morning fog through the pine trees 🌲🌫️ #forest #peace",               likes:40, likedBy: [],bookmarkedBy: [], comments:["naturelover: magical"],                                     img: categoryImages.nature[3] },
        { id:4,  user:"sara.lens",      category:"photography", text:"chasing light, finding calm 📷 #photography",                         likes:19, likedBy: [],bookmarkedBy: [], comments:[],                                                            img: categoryImages.photography[0] },
        { id:10, user:"lensbylu",       category:"photography", text:"shooting in film is a whole different feeling 🎞️ #analog",             likes:33, likedBy: [],bookmarkedBy: [], comments:[],                                                            img: categoryImages.photography[1] },
        { id:15, user:"shutterdan",     category:"photography", text:"caught this reflection completely by accident 🌀 #streetphoto",        likes:55, likedBy: [],bookmarkedBy: [], comments:["eyefordetail: incredible"],                                  img: categoryImages.photography[2] },
        { id:20, user:"goldenhour.g",   category:"photography", text:"you can never take too many sunset shots 🌇 #goldenHour",              likes:67, likedBy: [],bookmarkedBy: [], comments:["sunsetlvr: never tired of these"],                           img: categoryImages.photography[3] },
        { id:5,  user:"urbanwanderer",  category:"lifestyle",   text:"slow mornings are the best mornings ✨ #lifestyle",                   likes:8,  likedBy: [],bookmarkedBy: [], comments:[],                                                            img: categoryImages.lifestyle[0] },
        { id:9,  user:"the.minimalist", category:"lifestyle",   text:"decluttered my desk. my brain feels lighter 🪴 #minimal",             likes:29, likedBy: [],bookmarkedBy: [], comments:["simplelife: yes!! same energy"],                             img: categoryImages.lifestyle[1] },
        { id:14, user:"openpage",       category:"lifestyle",   text:"reading on the porch with tea > everything else 📖☕",                likes:18, likedBy: [],bookmarkedBy: [], comments:["bookworm.b: same"],                                          img: categoryImages.lifestyle[2] },
        { id:19, user:"quietspace",     category:"lifestyle",   text:"no phone sunday was the reset I needed 📵 try it",                    likes:14, likedBy: [],bookmarkedBy: [], comments:[],                                                            img: categoryImages.lifestyle[3] }
    ];
